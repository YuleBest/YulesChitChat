...
- 转载自：[blog.cloudflare.com](https://blog.cloudflare.com/zh-cn/18-november-2025-outage/)
- 原文发布时间：2025 年 11 月 18 日
- 原文标题：2025 年 11 月 18 日 Cloudflare 服务中断

:::

![|200x0](https://image.yule.ink/blog/cf_1.png)
...
![](https://image.yule.ink/blog/cf_2.png)
...
![](https://image.yule.ink/blog/cf_3.png)
...
| Access              | 从事件发生之初一直持续到 13:05 启动回滚为止，大多数用户普遍遭遇了身份验证失败。所有现有 Access 会话均未受到影响。<br><br>所有身份验证失败的尝试均导致显示错误页面，也就是说，在身份验证失败的情况下，没有任何用户能够访问目标应用。在此期间，所有成功的登录均已正确记录。<br><br>当时尝试的任何 Access 配置更新，要么直接失败，要么传播速度非常缓慢。现在，所有配置更新均已恢复。 |
...
![](https://image.yule.ink/blog/cf_4.png)
...
![](https://image.yule.ink/blog/cf_6.png)
...
![](https://image.yule.ink/blog/cf_7.png)
...
![](https://image.yule.ink/blog/cf_8.png)
...
![](https://image.yule.ink/blog/cf_10.png)
...
像今天这样的服务中断是不可接受的。Cloudflare 设计的系统架构具有极高的故障恢复能力，以确保流量始终畅通无阻。过去发生的故障总会促使我们构建全新的、更有韧性的系统。
